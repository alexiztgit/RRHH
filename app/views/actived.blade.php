...
<!--Comienza Estructura-->
                    <div role="tabpanel" class="tab-pane active" id="personal-activo">
                       <div class="panel panel-primary">
                            <div class="panel-heading">Personal Activo</div>
                                <div class="panel-body">
                                            ...
                                            foreach ($empleados as $e) { 
                                              ...
                                              <tr>
                                                ...
                                                <!--
                                                    ...
                                                    <button onclick="location.href='/legajo/<?=$e['id']?>/edit';" type="button" class="btn btn-primary" aria-label="Left Align">
                                                      <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar
                                                    </button>
                                                    <button onclick="location.href='/legajo/<?=$e['id']?>/view';" type="button" class="btn btn-primary" aria-label="Left Align">
...
<!--Comienza Estructura-->
                    <div role="tabpanel" class="tab-pane" id="personal-inactivo">
                       <div class="panel panel-primary">
...
<!--Comienza Estructura-->
                    <div role="tabpanel" class="tab-pane" id="nuevo-legajo">
                       <div class="panel panel-primary">
                            <div class="panel-heading">Nuevo Legajo</div>
                                <div class="panel-body">
    								<div class="row">
                                         <div class="col-md-2">
