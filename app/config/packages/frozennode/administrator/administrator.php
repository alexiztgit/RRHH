...
return array(
	...
	'menu' => array(
		...
		// '|ctors',
		// 'theaters',
		'Lugares' => array('country', 'city', 'locality','province', 'split'),
		'Empleado' => array('document_type','status', 'disability_type', 'kinship', 'Contacto' => array('type', 'contact_type')),
		'Datos Médicos' => array('medical_social','prepaid','art'),
		'Legajo' => array('area', 'job_status', 'additional', 'supplement'),
		'Lugares de Trabajo' => array('building','office'),
		'Revista' => array('grouping','scale', 'stretch', 'category', 'role'),
		'Educación' => array('institution','education_level','education_status','it_area','it_level','language'),
		'Antecedentes Laborales' => array('administrative_act', 'disciplinary_action', 'review_situation'),
		'Licencias' => array('license_scale')
		//'Settings' => array('settings.site'),
	),
	/**
